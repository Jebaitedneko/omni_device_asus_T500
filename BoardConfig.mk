...
# Assert
TARGET_OTA_ASSERT_DEVICE := T500

# Partitions
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 8634368 # This is the maximum known partition size, but it can be higher, so we just omit it
